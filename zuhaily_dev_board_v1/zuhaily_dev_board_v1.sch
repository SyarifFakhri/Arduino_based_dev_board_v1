...
voltage regulators\n\n
$Comp
L ESP8266:ESP-01v090 U_ESP1
U 1 1 5C52D7F9
P 11300 9850
F 0 "U_ESP1" H 11300 10365 50  0000 C CNN
...
$EndComp
Wire Wire Line
	12250 9700 12300 9700
$Comp
L Connector:Conn_01x04_Female J_oled_header1
U 1 1 5C533EE5
P 11100 7650
F 0 "J_oled_header1" H 11127 7626 50  0000 L CNN
F 1 "Conn_01x04_Female" H 11127 7535 50  0000 L CNN
F 2 "Connector:FanPinHeader_1x04_P2.54mm_Vertical" H 11100 7650 50  0001 C CNN
...
U 1 1 5C9564FE
P 10400 7650
F 0 "SW5" H 10400 8117 50  0000 C CNN
F 1 "SW_DIP_x04" H 10400 8026 50  0000 C CNN
F 2 "Button_Switch_THT:SW_DIP_SPSTx04_Slide_9.78x12.34mm_W7.62mm_P2.54mm" H 10400 7650 50  0001 C CNN
...
U 1 1 5C991126
P 9150 9850
F 0 "SW4" H 9150 10317 50  0000 C CNN
F 1 "SW_DIP_x04" H 9150 10226 50  0000 C CNN
F 2 "Button_Switch_THT:SW_DIP_SPSTx04_Slide_9.78x12.34mm_W7.62mm_P2.54mm" H 9150 9850 50  0001 C CNN
...
U 1 1 5C9B0797
P 8750 10050
F 0 "#PWR0116" H 8750 9800 50  0001 C CNN
F 1 "GND" H 8755 9877 50  0000 C CNN
...
Wire Wire Line
	9850 9650 9450 9650
Wire Wire Line
	9850 9700 10350 9700
Wire Wire Line
	9650 10000 9650 9850
Wire Wire Line
	9650 9850 9450 9850
Wire Wire Line
	9650 10000 10350 10000
Wire Wire Line
	12400 10000 12400 10250
Wire Wire Line
	12400 10250 9750 10250
Wire Wire Line
	9750 10250 9750 9750
Wire Wire Line
	9750 9750 9450 9750
Wire Wire Line
	12300 9700 12300 10350
Wire Wire Line
	12300 10350 9500 10350
Wire Wire Line
	9500 10350 9500 9950
Wire Wire Line
	9500 9950 9450 9950
...
Wire Wire Line
	10700 7750 11300 7750
$Comp
L Timer_RTC:DS1307Z+ U6
U 1 1 5C5C03AE
P 23100 6600
F 0 "U6" H 23641 6646 50  0000 L CNN
F 1 "DS1307Z+" H 23641 6555 50  0000 L CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 23100 6100 50  0001 C CNN
F 3 "https://datasheets.maximintegrated.com/en/ds/DS1307.pdf" H 23100 6600 50  0001 C CNN
	1    23100 6600
	1    0    0    -1  
$EndComp
...
SCL
Text Label 23000 5850 0    50   ~ 0
5V_REGULATED
Wire Wire Line
	23000 6200 23000 6050
Wire Wire Line
	23100 6200 23100 6050
Wire Wire Line
	23100 6050 23000 6050
Connection ~ 23000 6050
Wire Wire Line
	23000 6050 23000 5850
Wire Wire Line
	22600 6700 22150 6700
Wire Wire Line
	22150 6700 22150 6650
$Comp
L power:GND #PWR0127
U 1 1 5C665D4A
P 23100 7150
F 0 "#PWR0127" H 23100 6900 50  0001 C CNN
F 1 "GND" H 23105 6977 50  0000 C CNN
F 2 "" H 23100 7150 50  0001 C CNN
F 3 "" H 23100 7150 50  0001 C CNN
	1    23100 7150
	1    0    0    -1  
$EndComp
Wire Wire Line
	23100 7150 23100 7000
$Comp
L Device:R R_SCL1
U 1 1 5C682EB7
P 22400 6250
F 0 "R_SCL1" H 22470 6296 50  0000 L CNN
F 1 "10k" H 22470 6205 50  0000 L CNN
F 2 "Resistor_THT:R_Axial_DIN0207_L6.3mm_D2.5mm_P7.62mm_Horizontal" V 22330 6250 50  0001 C CNN
F 3 "~" H 22400 6250 50  0001 C CNN
	1    22400 6250
	1    0    0    -1  
$EndComp
Wire Wire Line
	22400 6400 22600 6400
Text Label 22400 6100 0    50   ~ 0
5V_REGULATED
$Comp
L Device:R R_SDA1
U 1 1 5C697913
P 22050 6350
F 0 "R_SDA1" H 22120 6396 50  0000 L CNN
...
Wire Wire Line
	22050 6200 22050 6100
Wire Wire Line
	22050 6100 22400 6100
Wire Wire Line
	22050 6500 22600 6500
Connection ~ 22400 6400
$Comp
L Switch:SW_DIP_x02 SW_RTC1
U 1 1 5C6D7AD0
P 21050 6500
F 0 "SW_RTC1" H 21050 6867 50  0000 C CNN
F 1 "SW_DIP_x02" H 21050 6776 50  0000 C CNN
F 2 "Button_Switch_THT:SW_DIP_SPSTx02_Slide_9.78x7.26mm_W7.62mm_P2.54mm" H 21050 6500 50  0001 C CNN
F 3 "" H 21050 6500 50  0001 C CNN
	1    21050 6500
	1    0    0    -1  
$EndComp
Wire Wire Line
	21350 6400 22400 6400
Wire Wire Line
	21350 6500 22050 6500
Wire Wire Line
	20750 6400 20600 6400
Wire Wire Line
	20750 6500 20600 6500
$Comp
L Device:Crystal_GND3 Y3
U 1 1 5C76D523
P 21700 6800
F 0 "Y3" H 21700 7068 50  0000 C CNN
F 1 "Crystal_GND3" H 21700 6977 50  0000 C CNN
F 2 "Crystal:Crystal_AT310_D3.0mm_L10.0mm_Horizontal_1EP_style1" H 21700 6800 50  0001 C CNN
F 3 "~" H 21700 6800 50  0001 C CNN
	1    21700 6800
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5C782F61
P 21700 7000
F 0 "#PWR0128" H 21700 6750 50  0001 C CNN
F 1 "GND" H 21705 6827 50  0000 C CNN
...
$EndComp
Wire Wire Line
	21850 6800 22600 6800
Wire Wire Line
	21550 6650 21550 6800
Wire Wire Line
	21550 6650 22150 6650
$EndSCHEMATC
